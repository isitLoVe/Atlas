...
AtlasEK = {
	BlackrockDepths = {
		...
		GREY.."6) Ring of Law (Page 1)";
		GREY.."6) Ring of Law (Page 2)";
		GREY.."7) Mon. of Franclorn Forgewright";
		GREY..INDENT.."Houndmaster Grebmar";
