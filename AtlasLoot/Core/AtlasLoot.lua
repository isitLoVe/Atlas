...
ATLASLOOT_VERSION = "|cffFF8400AtlasLoot PRE-TBC v"..VERSION_MAJOR.."."..VERSION_MINOR.."."..VERSION_BOSSES.."|r";
ATLASLOOT_CURRENT_ATLAS = "1.8.5a |cFFFF8080PRE-TBC|r";
...
-- Initialise saved variables
	...
	if ( AtlasLootOptions["SilentMode"] == nil ) then
        AtlasLootOptions["SilentMode"] = false;
    end
...
function AtlasLoot_SetItemInfoFrame(pFrame)
	...
	AtlasLootItemsFrame:Show();
	if AtlasLootItemsFrame:GetParent()==AtlasLootDefaultFrame_LootBackground then --If we are browsing through standart frame, we'll hide the close button.
